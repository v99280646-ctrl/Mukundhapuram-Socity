...
import { N as Briefcase, O as CircleCheckBig, S as FileText, T as CreditCard, c as Shield, f as Phone, h as Mail, i as User, m as MapPin, u as Send, y as IndianRupee } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/apply-D_wy7PGB.js
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: `h-10 w-10 rounded-full grid place-items-center text-sm font-semibold ${done ? "bg-success text-white" : active ? "bg-gradient-primary text-gold-foreground shadow-elegant" : "bg-card border border-border text-muted-foreground"}`,
