...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Loans, kuries, gold loans and fixed deposits with attractive rates from Mukundhapuram Socity Limited." },
      { property: "og:title", content: "Mukundhapuram Socity Limited" },
      { property: "og:description", content: "Your trusted partner for loans, kuries, and fixed deposits." },
